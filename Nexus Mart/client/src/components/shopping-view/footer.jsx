    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.column}>
          ...
          <p style={styles.text}>
            NexusMart Commerce Private Limited is a leading platform for electronics and gadgets. 
        ...
        <div style={styles.column}>
          ...
          <p style={styles.contact}>
            <FaPhoneAlt style={styles.iconSmall} /> +91-XXXXXXXXXX
          </p>
          <p style={styles.contact}>
            <FaEnvelope style={styles.iconSmall} /> support@nexusmart.com
          </p>
          {/* <p style={styles.contact}>
            <FaMapMarkerAlt style={styles.iconSmall} />Chandigarh, 
          </p> */}
        </div>
      ...
      <div style={styles.bottomBar}>
        <p style={styles.bottomText}>&copy; {new Date().getFullYear()} NexusMart Commerce Private Limited. All rights reserved.</p>
